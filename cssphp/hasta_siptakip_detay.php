...
$siparisNo = isset($_GET['sip_no']) ? $_GET['sip_no'] : '';

// Siparişi getiren sorgu
$query = $db->prepare("SELECT * FROM siparisler WHERE sip_no = :sip_no");
$query->bindValue(':sip_no', $siparisNo);
$query->execute();
$siparis = $query->fetchAll(PDO::FETCH_ASSOC);
?>
    ...
    <section style="color:white" id='list-section'>
        <div class='list-container'>
            ...
            <table>
                ...
                <tbody>
                   <?php foreach ($siparis as $siparisDetay) : ?>
                        <tr>
                            <td><?php echo $siparisDetay['ilac']; ?></td>
                            <td><?php echo $siparisDetay['sip_aded']; ?></td>
                            <td><?php echo $siparisDetay['sip_durum']; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
